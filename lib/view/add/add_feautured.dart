...
class AddFeautured extends StatefulWidget {
  // final VoidCallback reload;
  // AddFeautured(this.reload);

  @override
  _AddFeauturedState createState() => _AddFeauturedState();
}

class _AddFeauturedState extends State<AddFeautured> {
  File _imageFile;
  ...
  submit() async {
    try {
      ...
      var uri = Uri.parse(Api.addFeautured);
