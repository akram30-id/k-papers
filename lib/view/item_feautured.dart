...
class ItemFeautured extends StatefulWidget {
  final ImageModel model;
  ItemFeautured(this.model);

  @override
  _ItemFeauturedState createState() => _ItemFeauturedState();
}

class _ItemFeauturedState extends State<ItemFeautured> {
